...
public class QueryACDSplitTsapiProvider implements ITsapiProviderEx,
		PrivateData, ITsapiProviderPrivate, LucentV7Provider {
	...
	@Override
	public void addObserver(ProviderObserver arg0)
			throws TsapiResourceUnavailableException {
		tsapiProvider.addObserver(arg0);
	}

	@Override
	public void addProviderListener(ProviderListener arg0)
	...
	public int getCurrentStateOfCallByForceQueryOnTelephonyServer(Call tsapiCall) {
		return tsapiProvider
				.getCurrentStateOfCallByForceQueryOnTelephonyServer(tsapiCall);
	}

	@Override
	public int getCurrentStateOfCallByForceQueryOnTelephonyServer(int arg0) {
		return tsapiProvider
				.getCurrentStateOfCallByForceQueryOnTelephonyServer(arg0);
	}
	...
	@Override
	public final Terminal getTerminal(String arg0)
	...
	@Override
	public final TerminalConnection getTerminalConnection(ConnectionID arg0,
			Terminal arg1) {
	...
	public Address getAddress(String number) throws InvalidArgumentException {
		...
		return new QueryACDSplitACDAddressImpl(lucentACDAddressImpl.tsDevice,
				acdAddress);
	}
