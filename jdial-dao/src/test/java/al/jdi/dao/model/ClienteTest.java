...
public class ClienteTest {
	...
	public void defaultAgendamento() {
		assertThat(cliente.getAgendamento(),
	...
	public void defaultCriacaoModificacao() {
		assertThat(cliente.getCriacaoModificacao(),
				is(not(nullValue(CriacaoModificacao.class))));
	}

	@Test
	public void defaultDisponivelAPartirDe() {
		assertThat(cliente.getDisponivelAPartirDe(),
				is(not(nullValue(DateTime.class))));
	}
	...
	public void defaultHistoricoCliente() {
		assertThat(cliente.getHistoricoCliente(),
				is(not(nullValue(Collection.class))));
	...
	public void defaultUltimaMudancaEstado() {
		assertThat(cliente.getUltimaMudancaEstado(),
				is(not(nullValue(DateTime.class))));
	}
