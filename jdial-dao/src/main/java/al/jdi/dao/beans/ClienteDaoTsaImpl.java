...
class ClienteDaoTsaImpl extends ClienteDaoImpl implements ClienteDaoTsa {
  private final Logger logger = LoggerFactory.getLogger(getClass());

  ClienteDaoTsaImpl(Session session) {
    super(session);
  }
  ...
  public boolean isDnc(Cliente cliente, String nomeBaseDados) {
    ...
    BigInteger qtdDnc =
        (BigInteger) getSession().createSQLQuery(hql)
  ...
  public void limpaReserva(Cliente cliente, int operadorDiscador, String nomeBaseDados) {
    super.limpaReserva(cliente, operadorDiscador, nomeBaseDados);
  ...
  public void limpaReservas(Campanha campanha, String nomeBaseDados, String nomeBase, int operador) {
    super.limpaReservas(campanha, nomeBaseDados, nomeBase, operador);
    String hql =
